...
// If in queue, duration is updated
// If in session, SessionId is updated
// If not in either, this is updated as well
...
export const matchStatusStream = (req: Request, res: Response) => {
    ...
    const intervalTime = 500; // Check every 0.5 second
    ...
    }, intervalTime); // Check every 0.5 second
