...
describe('QuestionList', () => {
  const mockQuestions = [
    { _id: '1', title: 'Question 1', description: 'Description 1', categories: ['algorithms'], difficulty: 'easy' },
    { _id: '2', title: 'Question 2', description: 'Description 2', categories: ['data-structures', 'graphs'], difficulty: 'medium' },
  ];
